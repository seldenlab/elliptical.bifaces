...
```{r figillust, fig.cap="Illustrated elliptical bifaces from the ancestral Caddo area highlighting parallel-oblique flaking used in production. Additional information is included in the manuscript."}
