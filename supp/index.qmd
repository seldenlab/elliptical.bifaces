...
Duck River and other sword-form bifaces are also present at Spiro Mound [@RN2720], with the longest measuring 55.9cm. Smaller elliptical biface forms, roughly half the size of the larger form, have also been identified at Spiro, along with several wooden implements that Early [-@RN1052] interpreted as memetic of elliptical bifaces. The bifaces from this latter category are the focus of this study, which is aimed at assessing whether resharpening and/or retouch may have resulted in convergent morphology at two sites in the ancestral Caddo area. A measure of morphological disparity is subsequently to assess whether biface morphology is more diverse at the larger size, which would suggest greater diversity in biface shape or size related to production activities. 
